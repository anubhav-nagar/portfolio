const ProjectCard = ({project}) => {
  return (
    <div className='text-slate-200 my-auto bg-white rounded-3xl  w-[250px] md:w-[300px] mt-8 mr-8 hover:scale-105 transition-all duration-300 ease-in-out self-center'>
